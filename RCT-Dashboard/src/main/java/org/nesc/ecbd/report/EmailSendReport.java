...
import org.nesc.ecbd.config.InitConfig.Email;
import org.nesc.ecbd.entity.*;
import org.nesc.ecbd.report.converseFactory.ReportDataConverseFacotry;
import org.nesc.ecbd.util.ExcelUtil;
import org.nesc.ecbd.util.FileUtil;
...
public class EmailSendReport {
    ...
    public void sendEmailReport(RDBAnalyze rdbAnalyze,Email emailInfo, Map<String,Set<String>> reportData, Map<String, ReportData> latestPrefixData) {
        ...
        try {
            ...
            String subject = rdbAnalyze.getRedisInfo().getName()+" "+emailInfo.getSubject() +" "+ time;
